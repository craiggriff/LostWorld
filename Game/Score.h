...
namespace Game
{
	...
	class Score : Sparticle
	{
	public:
		Score(AllResources* p_Resources) : Sparticle(p_Resources) {};
		~Score(void);
		...
		void CreateOne(float x, float y, float z, float mx, float my, float mz, DirectX::XMFLOAT4 col, int start_delay);

		concurrency::task<void> CreateVerticies();
