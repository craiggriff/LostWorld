...
bool OrthoWindowClass::InitializeBuffers(ID3D11Device* device, int windowWidth, int windowHeight)
{
	...
	vertices = new OrthVertexType[m_vertexCount];
	if (!vertices)
	{
		return false;
	}
	...
	// First triangle.
	vertices[0].position = DirectX::XMFLOAT3(right, top, 0.0f);  // Top left.
	...
	vertices[1].position = DirectX::XMFLOAT3(left, bottom, 0.0f);  // Bottom right.
	vertices[1].texture = DirectX::XMFLOAT2(1.0f, 1.0f);



	// Second triangle.
	vertices[3].position = DirectX::XMFLOAT3(right, top, 0.0f);  // Top left.
	vertices[3].texture = DirectX::XMFLOAT2(0.0f, 0.0f);

	vertices[5].position = DirectX::XMFLOAT3(left, bottom, 0.0f);  // Bottom right.
	vertices[5].texture = DirectX::XMFLOAT2(1.0f, 1.0f);

	vertices[4].position = DirectX::XMFLOAT3(left, top, 0.0f);  // Top right.
	...
	vertexBufferDesc.ByteWidth = sizeof(OrthVertexType) * m_vertexCount;
