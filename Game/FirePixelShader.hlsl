...
cbuffer DistortionBuffer: register(b7)
{
	float2 distortion1;
	float2 distortion2;
	float2 distortion3;
...
float3 col = (fireColor.r + fireColor.g + fireColor.b)*0.33333333f;


fireColor.r = (fireColor.r*0.3f) + (input.color.r*0.7f);
fireColor.g = (fireColor.g*0.3f) + (input.color.g*0.7f);
fireColor.b = (fireColor.b*0.3f) + (input.color.r*0.7f);
